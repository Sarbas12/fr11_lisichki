...
let sortedData = [[], [], []] // 0 buses, 1 jeep, 2 yacht
const sortDataSide = () =>{
        let tourdata = [[], [], []]
...
const applyParametersMain = () =>{
    ...
    try{newActive.classList.add("button__active");}
    catch {
        return
    }
...
applyButtonSide.onclick = function (){applyParametersSide()}

applyButtonMain.onclick = function () {applyParametersMain()}